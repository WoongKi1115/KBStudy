...
class UsingMethodExam{
	...
	*/	
	public String methodExam03_02(String x, int y) {
		System.out.println("methodExam03_02가 호출되었습니다.");
		String result = x + "바보";
		System.out.println(result);
		int result2 = this.methodExam03_01(y);
     ...
     (구현부에서)하는 일 : 
		...
		methodExam03_02호출
	*/	
	void methodExam03_03(int x, String y) {
		System.out.println("methodExam03_03이 호출되었습니다.");
		this.methodExam03_02(y, x);
	}
	...
	*/	
	protected double methodExam03_04(int x, float y, int z) {
		System.out.println("methodExam03_04가 호출되었습니다.");
		MakeMethodExam02 exam = new MakeMethodExam02();
		double result = exam.methodExam02_04(x, y, z);
		return result;
	}
} // UsingMethodExam 끝
...
class UsingMethod{
	public static void main(String[] args) {
		UsingMethodExam x = new UsingMethodExam();
		System.out.println(x.methodExam03_02(null, 0));
		x.methodExam03_03(0, null);
		System.out.println(x.methodExam03_04(0, 0, 0));
	}
	//메인메소드에서
